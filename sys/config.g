...
G31 C0 P500 X23.4 Y-17 Z0.2		; Probe at [X/Y], no Z temperature coefficient, Z=1 when probe=500.

;M556 S78 X0 Y0 Z0         	        ; Axis compensation

M208 X426 Y126 Z147.5	; default max travel. IMPORTANT: Z travel range permits tool crashes.
